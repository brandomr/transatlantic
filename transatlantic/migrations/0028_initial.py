...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rango_userprofile', (
            ...
            ('bio', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.create_table(u'rango_page', (
            ...
            ('views', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('likes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('drafter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], to_field='username')),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 20, 0, 0))),
        ))
    ...
    models = {
        ...
        u'rango.page': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 20, 0, 0)'}),
            'drafter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'to_field': "'username'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'likes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
