...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'rango_userprofile', 'bio')

        # Deleting field 'UserProfile.location'
        db.delete_column(u'rango_userprofile', 'location')
